...
var scenery = {
    ...
    levelNameStyle: { font: "80px armalite", fill: "#fff", align: "center" },
    commonTextStyle: { font: "36px armalite", fill: "#fff", align: "center" },
    subHeadingTextStyle: { font: "44px armalite", fill: "#fff", align: "center" },
    buttonTextStyle: { font: "54px armalite", fill: "#fff", align: "center" },
    healthWarningStyle: { font: "44px armalite", fill: "#8B0000", align: "center" },
    panickerShoutStyle: { font: "18px arial", fill: "#fff", align: "center" },
...
var SceneBuilder = function (state) {
    ...
    if (state.key == "tutorial") {
        ...
        state.pointer.height = 100;
        state.pointer.anchor.set(0.5);
        state.pointer.alpha = 0;
        state.pointer.inputEnabled = true;
        state.pointer.input.priorityID = 1;
        state.pointer.input.useHandCursor = true;
    }
    if (state.key != "stage") {
